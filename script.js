...
var container, HEIGHT,
    ...
    function init(){
        ...
        var x = 0, y = 0;
				...
				heartShape.bezierCurveTo( x - 50, y - 50, x - 50, y + 25, x+30, y +25);//右上弧
				heartShape.bezierCurveTo( x + 75, y + 10, x + 80, y - 75, x + 75,y - 75 ); //右中弧
				heartShape.bezierCurveTo( x + 75, y - 85, x + 55, y - 170, x - 45, y - 200 );//右下弧
				heartShape.bezierCurveTo( x - 85, y - 200, x - 180, y - 120, x - 170, y - 55 );//左下弧
